...
## Project Structure
    ...
    ├── android_deploy_aug__36545  # Django project configurations
...
1. Clone this repo and `cd android_deploy_aug__36545`
...
2. Clone this repo and `cd android_deploy_aug__36545`
